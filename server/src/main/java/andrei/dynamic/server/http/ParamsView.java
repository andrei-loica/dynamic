...
public class ParamsView extends View{
	...
	String content = headWithCss() + "<body>" + menu(3) + "<div id=\"params-content\"><div class=\"description\"><span>Configuration parameters</span><form action=\"/update/configuration\" method=\"POST\" enctype=\"application/x-www-form-urlencoded\"></div><div class=\"part\"><ul><li>IP port for connection listener:</li><li>IP port for file transfer:</li><li>IP port for Web Server:</li><li>Maximum client connections:</li><li>Maximum directory checking depth:</li><li class=\"last\">Content checking period (milliseconds):</li></ul></div><div class=\"part\" id=\"param-values\"><div><input type=\"number\" name=\"localControlPort\" value=\""
